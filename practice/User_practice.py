class Customer():
    ...
    def make_withdrawal(self, amount):   #not withdrawaling 
        self.account_balance -= amount
        return self
...
customer1.make_deposit(100)
customer1.make_deposit(200)
customer1.make_deposit(200)
customer2.make_deposit(1000)
customer2.make_deposit(2000)
customer3.make_deposit(5000)

customer1.make_withdrawal(1000)
customer2.make_withdrawal(2000)
customer2.make_withdrawal(2000)
customer3.make_withdrawal(5000)
customer3.make_withdrawal(4000)
customer3.make_withdrawal(1000)
